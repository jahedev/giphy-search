          ...
          <div id='filter'>
            <div id='filterbutton'>
              <button
                ...
                onClick={() =>
                  this.componentDidMount(
                    `http://api.giphy.com/v1/gifs/random?api_key=sc71PXHt3BEJg208Ct4xBM6K5OTbJ4BT`
                  )
                }
              >
                {' '}
              ...
              <button
                ...
                onClick={() =>
                  this.componentDidMount(
                    `http://api.giphy.com/v1/gifs/trending?api_key=sc71PXHt3BEJg208Ct4xBM6K5OTbJ4BT`
                  )
                }
              >
                Tranding
